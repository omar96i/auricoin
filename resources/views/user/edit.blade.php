            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="region" name="region" value="{{ old('region', $user->region) }}">
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                ...
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="bank" name="bank" value="{{ old('bank', $user->bank) }}">
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <label for="type_bank" class="form-label">Tipo de Cuenta Bancaria</label>
                        <input type="text" class="form-control" id="type_bank" name="type_bank" value="{{ old('type_bank', $user->type_bank) }}">
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <label for="number_acount" class="form-label">Número de Cuenta Bancaria</label>
                        <input type="text" class="form-control" id="number_acount" name="number_acount" value="{{ old('number_acount', $user->number_acount) }}">
                    </div>

                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <label for="wallet_number" class="form-label">Número de Billetera</label>
                        <input type="text" class="form-control" id="wallet_number" name="wallet_number" value="{{ old('wallet_number', $user->wallet_number) }}">
                    </div>
                </div>
            </div>

            <button type="submit" class="bg-orange-gradient px-6 py-1 font-black float-right">Guardar Cambios</button>
            <button class="bg-orange-gradient px-6 py-1 font-black"><a href="{{ route('gerente.index') }}">Cancelar</a></button>
        </form>
    </div>
