    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('staff.update', $staff->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nit" name="nit" value="{{ old('nit', $staff->nit) }}" required>
            </div>

            <div class="mb-3">
                <label for="area" class="form-label">Área</label>
                <input type="text" class="form-control" id="area" name="area" value="{{ old('area', $staff->area) }}" required>
            </div>

            <button type="submit" class="bg-orange-gradient px-6 py-1 font-black mb-2">Guardar Cambios</button>
            <button class="bg-orange-gradient px-6 py-1 font-black mb-2"><a href="{{ route('staff.index') }}" class="">Cancelar</a></button>
        </form>
    </div>
