...
<body class="bg-body">
    ...
    <div class="container-fluid">
        ...
        <button class="bg-orange-gradient px-6 py-1 font-black mb-2"><a href="{{ route('staff.create') }}" class="">Agregar Personal</a></button>
            ...
            <tbody>
                @forelse($staffMembers as $staff)
                    <tr>
                        ...
                        <td>{{ $staff->area }}</td>
                        <td>
                            <button class="bg-orange-gradient px-6 py-1 font-black"><a href="{{ route('staff.edit', $staff->id) }}" class="">Editar</a></button>
                ...
                @empty
                    <tr>
                        <td colspan="5">No hay Personal registrados</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
