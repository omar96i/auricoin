    ...
    <header>
        ...
        <div class="flex justify-between place-items-center mx-4">
            <div class="flex place-items-center my-2 gap-8">
                ...
                <h2 class="text-title">Carta de creditos Revocable</h2>
            </div>
        </div>
        ...
        <div class="navbar w-full h-fit bg-orange-gradient flex justify-between align-middle px-2 py-3 text-nav mt-3">
            <div class="flex divide-x-2 divide-black">
                ...
                <a href="{{ route('revocable-index') }}" class="px-2">Carta de credito Revocable</a>
                <a href="{{ route('revocable-conditions') }}" class="px-2">Condiciones</a>
                <a href="{{ route('revocable-form') }}" class="px-2">Solicitud</a>
                <a href="{{ route('revocable-bills') }}" class="px-2">Gastos y comisiones</a>
            </div>
        </div>
    </header>
    <div class="p-5">
        ...
        <form method="POST" action="{{ route('letter-store') }}" enctype="multipart/form-data">
            @csrf
            <input type="text" value="Carta de credito revocable" name="type" style="display: none;">
            <div class="row">
                <!-- Primera etapa -->
                <div class="col-12">
