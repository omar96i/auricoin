    ...
    <header>
        ...
        <div class="flex justify-between place-items-center mx-4">
            <div class="flex place-items-center my-2 gap-8">
                ...
                <h2 class="text-title">Carta de creditos Directa</h2>
            </div>
        </div>
        ...
        <div class="navbar w-full h-fit bg-orange-gradient flex justify-between align-middle px-2 py-3 text-nav mt-3">
            <div class="flex divide-x-2 divide-black">
                ...
                <a href="{{ route('direct-index') }}" class="px-2">Carta de credito Directa</a>
                <a href="{{ route('direct-conditions') }}" class="px-2">Condiciones</a>
                <a href="{{ route('direct-form') }}" class="px-2">Solicitud</a>
                <a href="{{ route('direct-bills') }}" class="px-2">Gastos y comisiones</a>
            </div>
        </div>
    </header>
    <img src="{{ asset('direct-image.png') }}" alt="" class="img-fluid" width="100%">
