    ...
    <header>
        ...
        <div class="flex justify-between place-items-center mx-4">
            <div class="flex place-items-center my-2 gap-8">
                ...
                <h2 class="text-title">Carta de creditos Importacion e exportacion</h2>
            </div>
        </div>
        ...
        <div class="navbar w-full h-fit bg-orange-gradient flex justify-between align-middle px-2 py-3 text-nav mt-3">
            <div class="flex divide-x-2 divide-black">
                ...
                <a href="{{ route('importacion-index') }}" class="px-2">Carta de credito Importacion e exportacion</a>
                <a href="{{ route('importacion-conditions') }}" class="px-2">Condiciones</a>
                <a href="{{ route('importacion-form') }}" class="px-2">Solicitud</a>
                <a href="{{ route('importacion-bills') }}" class="px-2">Gastos y comisiones</a>
            </div>
        </div>
    </header>
    <div class="p-5">
        ...
        <form method="POST" action="{{ route('letter-store') }}" enctype="multipart/form-data">
            @csrf
            <input type="text" value="Carta de credito importacion" name="type" style="display: none;">
            <div class="row">
                <!-- Primera etapa -->
                <div class="col-12">
