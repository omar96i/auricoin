    ...
    <header>
        ...
        <div class="flex justify-between place-items-center mx-4">
            <div class="flex place-items-center my-2 gap-8">
                ...
                <h2 class="text-title">Carta de creditos Diferida</h2>
            </div>
        </div>
        ...
        <div class="navbar w-full h-fit bg-orange-gradient flex justify-between align-middle px-2 py-3 text-nav mt-3">
            <div class="flex divide-x-2 divide-black">
                ...
                <a href="{{ route('diferida-index') }}" class="px-2">Carta de credito Diferida</a>
                <a href="{{ route('diferida-conditions') }}" class="px-2">Condiciones</a>
                <a href="{{ route('diferida-form') }}" class="px-2">Solicitud</a>
                <a href="{{ route('diferida-bills') }}" class="px-2">Gastos y comisiones</a>
            </div>
        </div>
    </header>
    <div class="p-5">
        ...
        <form method="POST" action="{{ route('letter-store') }}" enctype="multipart/form-data">
            @csrf
            <input type="text" value="Carta de credito diferida" name="type" style="display: none;">
            <div class="row">
                <!-- Primera etapa -->
                <div class="col-12">
