    ...
    <div class="p-5">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <form method="POST" action="{{ route('memory-save') }}">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-sm-6" style="display: none;">
                            <label for="letter_credit_id" class="form-label">Id de carta de credito</label>
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="number" name="letter_credit_id" value="{{ $letter->id }}">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="number" name="sequence_of_the_total" >
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="form_of_documentary_credit">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="credit_number">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="reference_to_the_notice">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="date" name="date_of_issue">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="applicable_rules">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="place_expiration">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="date" name="date_expiration">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="enchange_ot_payer">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="ordering">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="beneficiary">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="beneficiary_direction">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="beneficiary_wallet_number">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="beneficiary_email">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="coint_payment">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="tolerance">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="number_commissions">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="partial_shipments">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="merchandise_loading_place">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="outside">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="destination">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="merchandise_destination">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="date" name="maximum_embargo_date">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="date" name="transfer_start_date">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="date" name="transfer_end_date">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="transshipment">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="description">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="required_document">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="place_of_destination">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="date" name="max_date_for_boarding">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="payment_condition">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-center">
                                <textarea name="merchandise_description" required class="form-control mr-2" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="ordering_duty">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="document_required">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-center">
                                <textarea name="condition_additional" required class="form-control mr-2" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="payment_method">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="expenses">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="presentation_period_days">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="confirmation_instructions">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="instructions_payments">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="report">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control mr-2" required type="text" name="information_sender">
                                <!-- Puedes agregar más elementos aquí si es necesario -->
                            </div>
                        </div>
