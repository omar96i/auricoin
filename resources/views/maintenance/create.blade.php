    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('maintenance.store') }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="proyect_id" name="proyect_id" required>
                    @foreach($proyects as $proyect)
                        <option value="{{ $proyect->id }}">{{ $proyect->area_raiz }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="fecha_final" name="fecha_final" value="{{ old('fecha_final') }}" required>
            </div>
            ...
            <button type="submit" class="bg-orange-gradient px-6 py-1 font-black">Agregar Mantenimiento</button>
