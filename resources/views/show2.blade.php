        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>ordenante numero billetera ric</th>
                    <th>ordenante pagina web</th>
                    <th>Tipo de carta</th>
                    <th>Accion</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($letters as $letter)
                    <tr>
                        ...
                        <td>{{ $letter->ordenante_rama_explota }} </td>
                        <td>{{ $letter->ordenante_numero_billetera_ric }} </td>
                        <td>{{ $letter->ordenante_pagina_web }} </td>
                        <td>{{ $letter->type }} </td>
                        <td>
                            <a href="/show2/{{ $letter->id }}" class="px-6 py-1 font-black"><button>Aprobar carta</button></a>
