    ...
    @if(session('success'))
        <div class="d-flex align-items-center justify-content-center" style="min-height: 60vh;">
            <div style="width: 400px;">
                <div class="card text-center p-3" style="background: #e7e6e6;">
                    <div class="text-center">
                        <img src="https://bancoexchangeauricoin.org/images/logo-auricoin.png" class="w-50" alt="Imagen del Banco">
                    </div>
                    <!-- Imagen centrada -->
                    <div class="card-body">
                        <!-- Título -->
                        <h5 class="card-title">Banco Exchange Auricoin</h5>
                        <!-- Descripción (variable) -->
                        <p class="card-text">{{ session('success') }}</p>
                    </div>

                    <div class="card-footer">
                        <!-- Footer con el año actual y el texto fijo -->
                        <p class="text-muted"><strong>© {{ date('Y') }} Banco Exchange Auricoin</strong></p>
                    </div>
                </div>
            </div>
        </div>
