    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('proyect.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="area_raiz" name="area_raiz" value="{{ old('area_raiz') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="alcance" name="alcance" required>
                    <option value="0-6meses" {{ old('alcance') == '0-6meses' ? 'selected' : '' }}>Baja 0-6 meses</option>
                    <option value="6-12meses" {{ old('alcance') == '6-12meses' ? 'selected' : '' }}>Media 6-12 meses</option>
                    <option value="12mesesplus" {{ old('alcance') == '12mesesplus' ? 'selected' : '' }}>Alta 12 meses o más</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="estado" name="estado" required>
                    ...
                    <option value="ejecucion" {{ old('estado') == 'ejecucion' ? 'selected' : '' }}>Ejecución</option>
                    <option value="cerrado" {{ old('estado') == 'cerrado' ? 'selected' : '' }}>Cerrado</option>
                    <option value="mantenimiento" {{ old('estado') == 'mantenimiento' ? 'selected' : '' }}>Mantenimiento</option>
                </select>
            </div>

            <button type="submit" class="bg-orange-gradient px-6 py-1 font-black">Agregar Proyecto</button>
